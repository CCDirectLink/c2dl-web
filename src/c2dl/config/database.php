    ...
    'connections' => [
        ...
        'main' => [
            ...
            'options' => extension_loaded('pdo_mysql') ? array_filter([
                PDO::MYSQL_ATTR_SSL_CA => env('MYSQL_ATTR_SSL_CA_MAIN'),
            ]) : [],
        ],
        ...
        'acc' => [
            ...
            'database' => env('DB_ACC_DATABASE', ''),
            'username' => env('DB_ACC_USERNAME', ''),
            ...
            'engine' => null,
            'options' => extension_loaded('pdo_mysql') ? array_filter([
                PDO::MYSQL_ATTR_SSL_CA => env('MYSQL_ATTR_SSL_CA_ACC'),
            ]) : [],
        ],
        ...
        'ext' => [
            ...
            'engine' => null,
            'options' => extension_loaded('pdo_mysql') ? array_filter([
                PDO::MYSQL_ATTR_SSL_CA => env('MYSQL_ATTR_SSL_CA_EXT'),
            ]) : [],
        ],
