<div class="c2dl-menu-hamburger" id="c2dl-menu-hamburger-1">
    <label class="c2dl-menu-trigger">
        ...
        <span class="c2dl-menu-trigger-hamburger">
            <span class="c2dl-svg-hamburger" id="c2dl-hamburger-icon-1"></span>
        </span>
        ...
        @browser('isSafari') c2dl-menu-drawer-safari-bg @else c2dl-menu-drawer-img-bg @endbrowser">
            ...
            <div class="c2dl-menu-drawer-footer">
                <div class="c2dl-menu-drawer-first">
                    <img class="c2dl-menu-drawer-logo" id="c2dl-menu-drawer-logo-1" src="{{ asset('https://storage.c2dl.info/assets/images/logo/c2dl/svg/CCDirectLink.min.svg') }}" width="2em" height="2em" alt="CCDirectLink (C2DL) Logo" title="CCDirectLink">
